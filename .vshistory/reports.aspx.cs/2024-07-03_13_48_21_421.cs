...
namespace SezwanPayroll
{
    public partial class reports : System.Web.UI.Page
    {
        ...
        [WebMethod()]
        public static List<clsSales> ShowSales(string dateFrom, string dateTo, string clientId, string vehicleRegNo, string agentName)
        {
            
            List<clsSales> sales = DbConnect.RecordSales(dateFrom,dateTo, clientId, vehicleRegNo, agentName);
