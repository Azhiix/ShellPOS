...
namespace SezwanPayroll
{
    public partial class Admin : System.Web.UI.Page
    {
        ...
        public static List<clsClient> updateCleintInfo(string name, string contactInfo, string address, string brn)
        {
            return DbConnect.updateClientInfo(name, contactInfo,address, brn);
