...
namespace SezwanPayroll
{
    public partial class Admin : System.Web.UI.Page
    {
        ...
        public static string CreateClient(string name, string contactInfo, string address, string brn,string registrationNo, List<clsVehicle> vehicles)
        {
            try
            {
                // Assuming DbConnect.CreateClient method is implemented correctly
                List<clsClient> newClient = DbConnect.CreateClient(name, contactInfo, address, brn, registrationNo, vehicles);
        ...
        {
            return DbConnect.updateClientInfo(clientId, name, contactInfo,address, brn);
