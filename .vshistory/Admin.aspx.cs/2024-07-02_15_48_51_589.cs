...
namespace SezwanPayroll
{
    public partial class Admin : System.Web.UI.Page
    {
        ...
        public static List<clsClient> retrieveAllClients(string Name, string contactInfo, string Address, string RegistrationNo, string DriverName)
        {
            return DbConnect.CreateClient(Name, contactInfo, Address, RegistrationNo, DriverName);
        }
