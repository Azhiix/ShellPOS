...
namespace SezwanPayroll
{
    public partial class Admin : System.Web.UI.Page
    {
        ...
        public static List<clsClient> retrieveAllClients(string name, string contactInfo, string address, string brn)
        {
            return DbConnect.CreateClient(name, contactInfo, address, brn);
        }
