...
<asp:Content ID="ContentBody" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container mt-5">
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-success mb-3">
                        <div class="card-body">
                            ...
                            <p class="card-text" id="totalSales"></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card text-white bg-warning mb-3">
                        <div class="card-body">
                            ...
                            <p class="card-text" id="totalItemsSold"></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="salesGrid" class="ag-theme-quartz mt-5" style="height: 400px;"></div>

        <div class="card p-4 mt-5">
            <h5 class="card-title">Pay Amount</h5>
            <form id="paymentForm">
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-md-3" id="paymentDateFromContainer">
                    ...
                    <div class="col-md-3" id="paymentDateToContainer">
                ...
                <div class="row g-3 align-items-center mt-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" id="paymentComments" rows="2" placeholder="Additional Comments"></textarea>
                    </div>
                </div>
                <div class="d-flex justify-content-end mt-4">
