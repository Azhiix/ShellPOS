...
<asp:Content ID="ContentBody" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container mt-5">
        ...
        <div class="totalPaid d-none">
            Total Amount Paid: <span id="totalAmountPaid"></span>
        </div>
        <div class="outstandingAmount d-none">
            Outstanding Amount: <span id="outstandingAmount"></span>
        </div>
