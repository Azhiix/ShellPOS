      ...
      <div class="card-body add-client">
          ...
          <div class=form-group mb-3>
            ...
            <input type="text" class="form-control" id="BrnNo"/>
              ...
              <!--Assigning a Vehicle to the client --> <%-- VehicleID	DriverName	RegistrationNo	Mileage	ClientID
1	Driver 1	ABC123	12000	1
2	Driver 2	XYZ789	15000	2
3	Driver 3	LMN456	20000	3
4	Faiza	CBE13098 	1250	1
5	Test	3140FTE	1254	1
6	Keval Odera	ABCDEF	25000	4--%>
              <div class="form-group mb-3" >

                  <label for="vehicleSelect" class="form-label">Assign Vehicle (Not required)</label>
                  <select class="form-select" id="vehicleSelect">
                        <option disabled selected>Select Vehicle</option>  </select>
