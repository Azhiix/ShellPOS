...
<div class="mt-4 mb-2" id="totalRegulatorQuantity" style="display: none;">
    ...
    <input type="number" class="form-control" id="regulatorQuantity" placeholder="Number of Regulators">
                    ...
                    <div class="col-md-6 col-12">
    <div id="ttoalGasRefillCost" style="display: none;" class="input-group mb-3">
        <span class="input-group-text">Total Cost: Rs</span>
        <input type="text" id="totalGasRefillAmount" class="form-control" aria-label="Total cost" readonly>
    </div>
</div>


                <div class="col-md-6 col-12">
<div class="mt-4 mb-2" id="totalGasRefillQuantity" style="display: none;">
    <label for="totalGasQuantity" class="form-label">Enter quantity of Regulators</label>
    <input type="number" class="form-control" id="totalGasQuantity" placeholder="Number of Regulators">
</div>
        ...
        <input type="text" id="totalRegulator" class="form-control" aria-label="Total cost" readonly>
          ...
          <div class="col-12 mt-2">
              <div class="form-check">
                  <input class="" type="text" id="itemCheck">
                  <label class="" for="itemCheck">
