...
<div class="col-md-6 col-12">
    <div id="totalRegulatorCost" style="display: none;" class="input-group mb-3">
        ...
        <input type="text" id="totalRegulator" class="form-control" aria-label="Total cost" readonly>
          ...
          <div class="col-md-6 col-12">
    <div class="mt-4 mb-2" id="gasRefillQuantityContainer" style="">
...
<div class="col-md-6 col-12">
    <div id="totalGasRefillCost" style="" class="input-group mb-3">
        <span class="input-group-text">Total Cost: Rs</span>
        <input type="text" id="totalGasRefill" class="form-control" aria-label="Total cost for gas refill" readonly>
    </div>
</div>
