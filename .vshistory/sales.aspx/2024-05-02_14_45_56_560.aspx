...
<div id="template" class="template mt-3" style="display: none;">
    <div class="dropdown-section">
        <select class="js-example-basic-single" name="subCategory">
            <!-- Options will be populated dynamically -->
        </select>
        <input type="text" class="quantity-input" style="display: none;" placeholder="Enter quantity">
