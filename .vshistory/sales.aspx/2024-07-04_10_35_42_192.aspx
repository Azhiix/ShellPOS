...
<asp:Content ID="ContentBody" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container full-height">
        ...
        <div class="client-info border p-4 mb-3 shadow-sm rounded">
            ...
            <fieldset>
                <legend>Select the type of Sale:</legend>
                <div class="d-flex flex-column">
                    <div class="form-check">
                        <input type="checkbox" id="scales" name="scales" class="form-check-input" checked />
                        <label for="scales" class="form-check-label">Credit</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" id="horns" name="horns" class="form-check-input" />
                        <label for="horns" class="form-check-label">Cash</label>
                    </div>
                </div>
            </fieldset>
