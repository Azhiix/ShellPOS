...
<div class="mt-4 mb-2" id="totalRegulatorQuantity" style="display: none;">
    <label for="couponQuantity" class="form-label">Enter quantity of Regulators</label>
    <input type="number" class="form-control" id="regulatorQuantity" placeholder="Number of coupons">
</div>
