...
//        Unchecked
    ...
    public static List<clsSales> RecordSales(string dateFrom, string dateTo, string clientId, string vehicleRegNo, string agentName)
    {
...
WHERE 1=1"; // Start with a WHERE clause that is always true to simplify appending conditions
            ...
            {
                sql += " AND u.Username = @AgentName";
                parameters.Add(new SqlParameter("@AgentName", agentName));
            }
