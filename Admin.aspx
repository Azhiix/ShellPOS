...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-5">
        ...
        <ul class="nav nav-tabs" id="adminTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="product-tab" data-bs-toggle="tab" data-bs-target="#product" type="button" role="tab" aria-controls="product" aria-selected="false">Products</button>
            </li>
        </ul>
                    ...
                    <div class="card-body add-client">
                        <form id="clientForm">
                            ...
                            <div id="vehicleInfoContainer">
                                <div class="vehicle-info form-group mb-3">
                            ...
                            <button type="button" class="btn btn-primary mb-3" id="addVehicleBtn"><i class="fas fa-plus"></i> Add Vehicle</button>
