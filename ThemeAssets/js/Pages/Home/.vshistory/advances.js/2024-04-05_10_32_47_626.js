...
function saveAdvanceContract() {
    ...
    const checkWhetherEmpty = [empPin, dateChosen, amntTaken, firstMonthDeduct, finalMonthDeduct, installmentsPerMonth, AmountMonthsDeduct];
if (checkWhetherEmpty.includes("")) {
        displayWarningMessage("Please fill in all fields before saving.");
        return;
    }
