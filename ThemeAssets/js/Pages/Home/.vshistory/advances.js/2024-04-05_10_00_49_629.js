...
function saveAdvanceContract() {
    ...
    jQuery.ajax({
        ...
        success: function (msg) {
            if (msg.d > 1) {
                displaySuccessMessage("Advance contract successfully saved");
                loadAdvances();
            }

            if (msg.d > 0) {
                displaySuccessMessage("You Already Have An advance for this employee. Proceed? ");
                if(confirm("You Already Have An advance for this employee. Proceed? ")){
                    displaySuccessMessage("Advance contract successfully saved");
                    loadAdvances();
                }
            }
