...
function checkIfAdvanceExists() {
    return new Promise(function (resolve, reject) {
        ...
        jQuery.ajax({
            ...
            data: JSON.stringify({ emp_pin: empPin, dateChosen: dateChosen, amntTaken: amntTaken, firstMonthDeduct: firstMonthDeduct, finalMonthDeduct: finalMonthDeduct, installmentsPerMonth: installmentsPerMonth, amtMonthsTaken: AmountMonthsDeduct }),
            contentType: "application/json; charset=utf-8",
            dataType: "JSON",
            success: function (msg) {
                if (msg.d > 0) {
