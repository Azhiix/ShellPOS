            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    for (var i = 0; i < msg.d.length; i++) {
                        ...
                        // Adjust dropdown based on bank name containing "cash"
                        var includeRecDropdown = record.bank.toLowerCase().includes("cash")
                            ? '<div class="select-menu"><div class="select-btn"><span class="sBtn-text">No</span><i class="fas fa-chevron-down"></i></div><ul class="options"><li class="option"><i class="fas fa-check-circle" style="color: #50CD89;"></i><span class="option-text">Yes</span></li><li class="option selected"><i class="fas fa-times-square" style="color: #E1306C;"></i><span class="option-text">No</span></li></ul></div>'
