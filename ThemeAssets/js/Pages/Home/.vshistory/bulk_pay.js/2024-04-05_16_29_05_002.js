...
var bulk_pay = function () {
    return {
        ...
        generateBulkFile: function () {
            ...
            var selectedOption = $('#compBranch').find(':selected');
            var selectedValue = selectedOption.val();
            var cashPaymentOption = 0;
            var accountPaymentAmount = 0;
            ...
            if (pmntDate === "" || !pmntDate) {
                ...
                table.rows().every(function () {
                    ...
                    if (selectValueText == 'Yes' && !bankName.includes('cash')) {
                        accountPaymentAmount += salaryVal

                    } elseif(selectValueText.trim() == 'No'  {
