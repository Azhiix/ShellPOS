                ...
                success: function (msg) {
                    ...
                    for (var i = 0; i < msg.d.length; i++) {
                        ...
                        var includeRecDropdown = record.bank.toLowerCase().includes("cash")
                            ? '<div class="select-menu"><div class="select-btn"><span class="sBtn-text">No</span></div><i class="fas fa-times-square" style="color: #E1306C;"></i><span class="option-text"</span></div>'
