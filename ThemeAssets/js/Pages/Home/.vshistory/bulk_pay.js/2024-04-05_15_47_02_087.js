            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    for (var i = 0; i < msg.d.length; i++) {
                        ...
                        var includeRecDropdown = record.bank.toLowerCase().includes("cash")
                            ? '<div class="select-static"><span class="static-text">Bank includes "cash": No</span><i class="fas fa-times-square" style="color: #E1306C;"></i><span class="static-option-text">No</span></div>'
