            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    for (var i = 0; i < msg.d.length; i++) {
                        var record = msg.d[i];
                        var recNo = i + 1; // Record number starts from 1
                        //var includeRecDropdown = '<select><option value="Y">Y</option><option value="N">N</option></select>';
                        var includeRecDropdown = '<div class="select-menu"><div class="select-btn"><span class="sBtn-text">Yes</span><i class="fas fa-chevron-down"></i></div><ul class="options"><li class="option"><i class="fas fa-check-circle" style="color: #50CD89;"></i><span class="option-text">Yes</span></li><li class="option"><i class="fas fa-times-square" style="color: #E1306C;"></i><span class="option-text">No</span></li></ul></div>';
                        var currency = "MUR";
