...
// When setting the employee ID
localStorage.setItem('employeeId', $(".empPinNoInput").val());

// When retrieving the employee ID
...
const handleRefresh = () => {
    ...
    jQuery.ajax({
        type: "GET",
        url: "addemployee.aspx/loadEmployeeDetails",
        data: {
            emp_pin: employeeId
        },
        contentType: "application/json; charset=utf-8",
        ...
        success: function (msg) {
            if (msg.d != null) {
                var emp = msg.d;
                displayInitializationPage(emp.img, emp.emp_pin);
