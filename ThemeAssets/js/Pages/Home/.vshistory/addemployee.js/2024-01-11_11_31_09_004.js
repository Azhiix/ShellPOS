    ...
    jQuery.ajax({
        ...
        success: function (lstEmp) {
            ...
            $.each(lstEmp.d, function (index, emp) {
                $(".uninitEmps").append('<button class="btn btn-sm btn-flex btn-light btn-active-primary fw-bolder changeEmployeeBtn mt-2" onclick="displayInitializationPage(\'' + emp.img + '\', \'' + emp.emp_pin + '\');"><img id="empFaceImg" src="data:image/png;base64,' + emp.img + '" alt="Embedded Image" width="35" height="45">  &nbsp Employee ID: &nbsp' + emp.emp_pin + '</button><br/>');
            });
