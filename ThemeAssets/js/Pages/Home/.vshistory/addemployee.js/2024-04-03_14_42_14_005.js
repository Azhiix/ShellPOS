    ...
    jQuery.ajax({
        ...
        success: function (msg) {
            if (msg.d != null) {
                ...
                <i class="fas fa-sync-alt refresh-icon" onclick="handleRefresh()" ${canRefresh ? '' : 'style="display: none;"'}></i>`); // Conditionally show/hide the icon based on canRefresh
