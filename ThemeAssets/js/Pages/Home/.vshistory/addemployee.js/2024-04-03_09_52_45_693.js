...
function displayInitializationPage(img, empPin) {
    ...
    $(".addempImage").html(`<img src="data: image / png; base64, ${img} class='add-emp-iamge'  " alt="Embedded Image" style="border-radius: 80px; "> 

   

    <div>
    <button class='refresh-icon' style="position: absolute; top:0, right:0, cursor:pointer;">Change Image</button>
