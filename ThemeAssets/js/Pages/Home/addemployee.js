    ...
    jQuery.ajax({
        ...
        success: function (msg) {
            if (msg.d != null) {
                ...
                $(".addempImage").html(`<img src="${newImage}" class='add-emp-image' alt="Embedded Image" style="border-radius: 80px; ">`); //overwriting the exisiting html
...
function InitEvents() {
    $(".empAccNoInput").on('input', function () {
...
function displayInitializationPage(img, empPin) {
    ...
    $(".addempImage").html(`<img src="data: image / png; base64, ${img}"  onclick="handleRefresh()" class='add-emp-image' alt="Embedded Image" style="border-radius: 80px; "> 
