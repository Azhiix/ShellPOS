...
//understand why none of the console.logs are displaying
function initializeEvents() {
    ...
    $('.leaveApplicationRequestBtn').click(function (event) {
        ...
        let requestData = JSON.stringify({ date: leaveDate, comments: leavePurpose, absenceType: leaveType });
    ...
    console.log("Leave request sent to the server");
