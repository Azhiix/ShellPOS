...
function splitNumber(num) {
    ...
    var decimalPart = Math.abs(num - integerPart);
...
function LoadLeaves(msg) {
    ...
    localLeavesSplit = splitNumber;
    console.log("new local leaves");
    localLeavesDiv.setAttribute('data-kt-countup-value', localLeavesSplit.integerPart);
    if (localLeavesSplit.decimalPart != 0) {
        localLeavesDiv.setAttribute('data-kt-countup-prefix', localLeavesSplit.integerPart);
    }
}
