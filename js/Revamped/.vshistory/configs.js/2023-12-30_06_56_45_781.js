    ...
    jQuery.ajax({
        ...
        success: function (msg) {
            ...
            if (msg.d == null) {
                ...
                // Call LoadEmployeeDocumentsDetails only if there is no error message
                if (!msg.d.documents.HasError) {
                    LoadEmployeeDocumentsDetails(msg.d.documents);
                } else {
                    // Optionally, you can handle the error message here
                    // For example, log it to the console or show an alert
