...
window.onload = function () {
    document.getElementById('upload-btn').addEventListener('change', function (event) {
        ...
        document.getElementById('<%= employeeIdUpload.ClientID %>').value = document.querySelector('.clsempid').value;
...
function loadDocuments() {
    ...
    var a = document.getElementById('<%= employeeIdUpload.ClientID %>');
    var b = document.getElementById('employeeIdUpload');


    document.getElementById('<%= employeeIdUpload.ClientID %>').value = inputValue;
}
