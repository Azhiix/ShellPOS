        ...
        success: function (response) {
            ...
            parsedRows.forEach(row => {
                ...
                table.row.add([
                    ...
                    "<a onclick='downloadDocument(\"" + row['uuid'] + "\",\"" + row['file_extension'] + "\")' class='btn btn-bg-secondary'>Download</a> <a onclick='downloadDocument(\"" + row['uuid'] + "\",\"" + row['file_extension'] + "\")' class='btn btn-bg-danger'>Remove</a>" // Fourth Column HTML
                ]).draw(false);
            }
            );
