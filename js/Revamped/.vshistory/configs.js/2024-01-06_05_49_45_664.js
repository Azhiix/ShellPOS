...
function loadShift() {
    ...
    $("#tblContent").html("<tr id='tblHead'><th> Employee Name</th > <th>Amount Taken(Rs)</th><th>Date Received</th> <th>Installments(Rs)</th><th>Start Month(inclusive)</th><th>End Month(inclusive)</th></tr>");
    jQuery.ajax({
        type: "POST",
