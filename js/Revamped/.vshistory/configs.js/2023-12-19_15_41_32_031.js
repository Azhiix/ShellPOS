...
function updateGridView(data) {
    var gridView = $("#" + gridViewItem);
    gridView.empty(); // Clear existing rows
    ...
    $.each(parsedData, function (index, item) {
        ...
        console.log(index);
        var row = $("<tr></tr>");
        // Add cells to the row based on your data structure
        row.append($("<td></td>").text(item.UUID));
        row.append($("<td></td>").text("abcd"));
        // ...add other cells...
    ...
    var row = $("<tr></tr>");
    gridView.append(row);
    console.log('len gridview');
    console.log(gridView.length);
}
