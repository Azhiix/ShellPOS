        ...
        success: function (successmsg) {
            ...
            $.each(successmsg.d, function (i, item) {
                var rowAttributes = {
                    ...
                    "data-sunday-start-time": item.shiftStart, // assuming these properties exist
                    "data-sunday-end-time": item.shiftEnd,
                    "data-sunday-working-day": item.workingDay,
                    "data-sunday-lateness-tolerance": item.latenessToleranceMinutes,
                    // Add similar attributes for other days
                };
                ...
                var rowNode = table.row.add(aggregatedData[key]).draw().node();
                $(rowNode).attr(rowAttributes);
            });

            $.each(aggregatedData, function (i, aggregatedRow) {
                //table.row.add(aggregatedRow);
                var rowNode = table.row.add(aggregatedRow).draw().node();
                $(rowNode).attr(rowAttributes);
            });
