        ...
        success: function (response) {
            ...
            parsedRows.forEach(row => {
                table.row.add([
                    ...
                    row['uuid'], // File name
                    'Employee Birth Certificate (test)', // Description
...
function downloadDocument(uuid, fileExtension) {
    $.ajax({
        type: "POST",
        url: "configs.aspx/DownloadFile", // Replace 'YourPageName.aspx' with the actual name of your ASPX page
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: JSON.stringify({ uuid: uuid, fileExtension: fileExtension }),
        success: function (response) {
            // Handle successful response here
            // If you are sending back the file for download, you might need a different approach
            window.location.href = 'YourPageName.aspx/DownloadFile?uuid=' + uuid + '&fileExtension=' + fileExtension; // This line triggers the file download
        },
