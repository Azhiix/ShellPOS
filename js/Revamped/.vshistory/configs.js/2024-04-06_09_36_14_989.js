...
function LoadPersonalDetails(msg) {
    ...
    var bankNum = msg.d.employee.bankNum;
    if (isNumeric(bankNum)) {
        $(".clsBankNum").val(bankNum).data('original-value', bankNum);
    } else {
        // we should otherwise return the previous value if the new value is not numeric
$(".clsBankNum").val($(".clsBankNum").data('original-value'));
