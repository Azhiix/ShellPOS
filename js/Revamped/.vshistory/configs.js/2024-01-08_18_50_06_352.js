...
function handleShifts() {
    ...
    $('#copyPreviousShiftValues').on('click', function () {
        ...
        if (shiftTemplateWrapper) {
            loadShiftData(shiftTemplateWrapper);
        } 
        loadShiftDataFromWrapper();
    });

}

function getShiftTemplateWrapper() {
    var shiftTemplateWrapperString = localStorage.getItem('shiftTemplateWrapper');
...
function createShift() {
    ...
    localStorage.setItem('shiftTemplateWrapper', JSON.stringify(dataToSend));
