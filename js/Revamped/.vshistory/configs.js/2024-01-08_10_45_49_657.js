...
$(document).ready(function () {
    ...
    $('#shiftTable').on('click', '.edit-btn', function () {
        ...
        $('#sundayWorkingDay').prop('checked', data.sundayWorkingDay === 1);
        ...
        $('#mondayWorkingDay').prop('checked', data.mondayWorkingDay === 1);
        ...
        $('#tuesdayWorkingDay').prop('checked', data.tuesdayWorkingDay === 1);
        ...
        $('#wednesdayWorkingDay').prop('checked', data.wednesdayWorkingDay === 1);
        ...
        $('#thursdayWorkingDay').prop('checked', data.thursdayWorkingDay === 1);
        ...
        $('#fridayWorkingDay').prop('checked', data.fridayWorkingDay === 1);
        ...
        $('#saturdayWorkingDay').prop('checked', data.saturdayWorkingDay === 1);
    ...
    if (!$.fn.dataTable.isDataTable('#shiftTable')) {
        var table = $('#shiftTable').DataTable({
            columns: [
                ...
                { title: "Overtime Rate", data: 'overtimeRate', visible: false },
                { title: "Extra Overtime Rate", data: 'extraOvertimeRate', visible: false },
            ...
            $.each(successmsg.d, function (i, item) {
                ...
                if (!aggregatedData[key]) {
                    aggregatedData[key] = {
                        ...
                        "extraOvertimeRate": item.extraOvertimeRate,
