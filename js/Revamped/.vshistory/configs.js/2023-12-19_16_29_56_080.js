...
function loadDocuments() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            rows = response.d;
            table.row.add([
                '<tr> <td> <div class="cursor-pointer symbol symbol-30px symbol-md-40px"> <img src="ThemeAssets/dist/assets/media/svg/files/doc.svg" alt="user" style="margin:5px;"> </div> </td> <td>Birth Certificate</td> <td>Employee Birth Certificate testttt</td> <td> <a href="#" class="btn btn-bg-secondary">Download</a> <a href="YourViewLinkOrFunctionHere" class="btn btn-bg-primary">View</a> </td> </tr>'
            ]).draw(false);
        },
