    ...
    $.ajax({
        ...
        success: function (successmsg) {
            ...
            $.each(successmsg.d, function (i, item) {
                ...
                aggregatedData[key][dayPrefix + "WorkingDay"] = item.workingDay ? 'Yes' : 'No';
                aggregatedData[key][dayPrefix + "LatenessTolerance"] = item.workingDay ? item.latenessToleranceMinutes + ' min' : '-';
            });
