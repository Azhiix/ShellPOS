...
$(document).ready(function () {
    ...
    $('#shiftTable').on('click', '.edit-btn', function () {
        ...
        $('#sundayWorkingDay').prop('checked', data.sundayWorkingDay === 'Yes');
        ...
        $('#mondayWorkingDay').prop('checked', data.mondayWorkingDay === 'Yes');
        ...
        $('#tuesdayWorkingDay').prop('checked', data.tuesdayWorkingDay === 'Yes');
        ...
        $('#wednesdayWorkingDay').prop('checked', data.wednesdayWorkingDay === 'Yes');
        ...
        $('#thursdayWorkingDay').prop('checked', data.thursdayWorkingDay === 'Yes');
        ...
        $('#fridayWorkingDay').prop('checked', data.fridayWorkingDay === 'Yes');
        ...
        $('#saturdayWorkingDay').prop('checked', data.saturdayWorkingDay === 'Yes');
