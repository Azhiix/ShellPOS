...
$(document).ready(function () {
    ...
    $('#saveChangesShiftCreation').click(function (e) {
        ...
        if (isValid) {
            var formData = {
                // Sunday data
                sundayStartTime: $('#sundayStartTime').val(),
                sundayEndTime: $('#sundayEndTime').val(),
                sundayWorkingDay: $('#sundayWorkingDay').is(':checked'),
                sundayLatenessTolerance: $('#sundayLatenessTolerance').val(),
                // Monday data
                mondayStartTime: $('#mondayStartTime').val(),
                mondayEndTime: $('#mondayEndTime').val(),
                mondayWorkingDay: $('#mondayWorkingDay').is(':checked'),
                mondayLatenessTolerance: $('#mondayLatenessTolerance').val(),
                // Tuesday data
                tuesdayStartTime: $('#tuesdayStartTime').val(),
                tuesdayEndTime: $('#tuesdayEndTime').val(),
                tuesdayWorkingDay: $('#tuesdayWorkingDay').is(':checked'),
                tuesdayLatenessTolerance: $('#tuesdayLatenessTolerance').val(),
                // Wednesday data
                wednesdayStartTime: $('#wednesdayStartTime').val(),
                wednesdayEndTime: $('#wednesdayEndTime').val(),
                wednesdayWorkingDay: $('#wednesdayWorkingDay').is(':checked'),
                wednesdayLatenessTolerance: $('#wednesdayLatenessTolerance').val(),
                // Thursday data
                thursdayStartTime: $('#thursdayStartTime').val(),
                thursdayEndTime: $('#thursdayEndTime').val(),
                thursdayWorkingDay: $('#thursdayWorkingDay').is(':checked'),
                thursdayLatenessTolerance: $('#thursdayLatenessTolerance').val(),
                // Friday data
                fridayStartTime: $('#fridayStartTime').val(),
                fridayEndTime: $('#fridayEndTime').val(),
                fridayWorkingDay: $('#fridayWorkingDay').is(':checked'),
                fridayLatenessTolerance: $('#fridayLatenessTolerance').val(),
                // Saturday data
                saturdayStartTime: $('#saturdayStartTime').val(),
                saturdayEndTime: $('#saturdayEndTime').val(),
                saturdayWorkingDay: $('#saturdayWorkingDay').is(':checked'),
                saturdayLatenessTolerance: $('#saturdayLatenessTolerance').val(),
                // Additional fields
                shiftDescription: $('#shiftDescription').val(),
                overtimeRate: $('#overtimeRate').val(),
                extraOvertimeRate: $('#extraOvertimeRate').val()
            };
