        ...
        if (isValid) {
            var formData = {
                Templates: [
                    ...
                    {
                        dayOfTheWeek: 2,
                        shiftStart: $('#tuesdayStartTime').val(),
                        shiftEnd: $('#tuesdayEndTime').val(),
            ...
            $.ajax({
                url: 'configs.aspx/createShiftTemplate', // Replace with your endpoint
                type: 'POST',
            ...
            $.ajax({
                url: 'configs.aspx/createShiftDetails', // Replace with your endpoint
                type: 'POST',
                contentType: 'application/json',
                data: JSON.stringify(dataToSend),
                success: function (response) {
