    ...
    var formData = {
        Templates: [
            // Sunday
            {
                ...
                latenessToleranceMinutes: parseInt($('#sundayLatenessTolerance').val(), 10) || 0
            },
            // Monday
            {
                dayOfTheWeek: 1,
                ...
                latenessToleranceMinutes: parseInt($('#mondayLatenessTolerance').val(), 10) || 0
            },
            // Tuesday
            {
                dayOfTheWeek: 2,
                ...
                latenessToleranceMinutes: parseInt($('#tuesdayLatenessTolerance').val(), 10) || 0
            },
            // Wednesday
            {
                dayOfTheWeek: 3,
                ...
                latenessToleranceMinutes: parseInt($('#wednesdayLatenessTolerance').val(), 10) || 0
            },
            // Thursday
            {
                dayOfTheWeek: 4,
                ...
                latenessToleranceMinutes: parseInt($('#thursdayLatenessTolerance').val(), 10) || 0
            },
            // Friday
            {
                dayOfTheWeek: 5,
                ...
                latenessToleranceMinutes: parseInt($('#fridayLatenessTolerance').val(), 10) || 0
            },
            // Saturday
            {
                dayOfTheWeek: 6,
                ...
                latenessToleranceMinutes: parseInt($('#saturdayLatenessTolerance').val(), 10) || 0
            }
        ],
