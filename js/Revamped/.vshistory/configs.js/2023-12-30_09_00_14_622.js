...
function handleTimesheetToggle(checkbox, toggleId, updateUrl) {
    ...
    jQuery.ajax({
        type: "POST",
        url: "configs.aspx/UpdateCLELStatus",
        headers: {
        ...
        success: function (msg) {
            ...
            if (msg.d) {
                alert('CLEL status successfully updated');
            } else {
                alert('Error while updating CLEL. Please contact your administrator.')
            }
        },
