    ...
    jQuery.ajax({
        ...
        success: function (successmsg) {
            for (var x = 0; x < successmsg.d.length; x++) {
                var day = findDayFromInteger(successmsg.d[x].dayOfTheWeek);
                var shiftStart = successmsg.d[x].shiftStart
                var shiftEnd = successmsg.d[x].shiftEnd
                var workingDay = successmsg.d[x].workingDay
                var latenessTolerance = successmsg.d[x].latenessToleranceMinutes
