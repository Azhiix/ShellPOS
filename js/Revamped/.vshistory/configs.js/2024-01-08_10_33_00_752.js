...
$(document).ready(function () {
    ...
    $('#saveChangesShiftCreation').click(function (e) {
    ...
    $('#shiftTable').on('click', '.edit-btn', function () {
        ...
        // Sunday
        $('#sundayStartTime').val(data.sundayStartTime);
        $('#sundayEndTime').val(data.sundayEndTime);
        $('#sundayWorkingDay').prop('checked', data.sundayWorkingDay === true);
        $('#sundayLatenessTolerance').val(data.sundayLatenessTolerance);

        // Monday
        $('#mondayStartTime').val(data.mondayStartTime);
        $('#mondayEndTime').val(data.mondayEndTime);
        $('#mondayWorkingDay').prop('checked', data.mondayWorkingDay === true);
        $('#mondayLatenessTolerance').val(data.mondayLatenessTolerance);

        // Tuesday
        $('#tuesdayStartTime').val(data.tuesdayStartTime);
        $('#tuesdayEndTime').val(data.tuesdayEndTime);
        $('#tuesdayWorkingDay').prop('checked', data.tuesdayWorkingDay === true);
        $('#tuesdayLatenessTolerance').val(data.tuesdayLatenessTolerance);

        // Wednesday
        $('#wednesdayStartTime').val(data.wednesdayStartTime);
        $('#wednesdayEndTime').val(data.wednesdayEndTime);
        $('#wednesdayWorkingDay').prop('checked', data.wednesdayWorkingDay === true);
        $('#wednesdayLatenessTolerance').val(data.wednesdayLatenessTolerance);

        // Thursday
        $('#thursdayStartTime').val(data.thursdayStartTime);
        $('#thursdayEndTime').val(data.thursdayEndTime);
        $('#thursdayWorkingDay').prop('checked', data.thursdayWorkingDay === true);
        $('#thursdayLatenessTolerance').val(data.thursdayLatenessTolerance);

        // Friday
        $('#fridayStartTime').val(data.fridayStartTime);
        $('#fridayEndTime').val(data.fridayEndTime);
        $('#fridayWorkingDay').prop('checked', data.fridayWorkingDay === true);
        $('#fridayLatenessTolerance').val(data.fridayLatenessTolerance);

        // Saturday
        $('#saturdayStartTime').val(data.saturdayStartTime);
        $('#saturdayEndTime').val(data.saturdayEndTime);
        $('#saturdayWorkingDay').prop('checked', data.saturdayWorkingDay === true);
        $('#saturdayLatenessTolerance').val(data.saturdayLatenessTolerance);
        ...
        $('#scheduleModal').data('mode', 'edit').modal('show');
    });
    ...
    if (!$.fn.dataTable.isDataTable('#shiftTable')) {
        var table = $('#shiftTable').DataTable({
            columns: [
                ...
                { title: "Template key", data: 'templateKey' },
                ...
                // Sunday
                { title: "Sunday Start Time", data: 'sundayStartTime', visible: false },
                { title: "Sunday End Time", data: 'sundayEndTime', visible: false },
                { title: "Sunday Working Day", data: 'sundayWorkingDay', visible: false },
                { title: "Sunday Lateness Tolerance", data: 'sundayLatenessTolerance', visible: false },
                // Monday
                { title: "Monday Start Time", data: 'mondayStartTime', visible: false },
                { title: "Monday End Time", data: 'mondayEndTime', visible: false },
                { title: "Monday Working Day", data: 'mondayWorkingDay', visible: false },
                { title: "Monday Lateness Tolerance", data: 'mondayLatenessTolerance', visible: false },
                // Tuesday
                { title: "Tuesday Start Time", data: 'tuesdayStartTime', visible: false },
                { title: "Tuesday End Time", data: 'tuesdayEndTime', visible: false },
                { title: "Tuesday Working Day", data: 'tuesdayWorkingDay', visible: false },
                { title: "Tuesday Lateness Tolerance", data: 'tuesdayLatenessTolerance', visible: false },
                // Wednesday
                { title: "Wednesday Start Time", data: 'wednesdayStartTime', visible: false },
                { title: "Wednesday End Time", data: 'wednesdayEndTime', visible: false },
                { title: "Wednesday Working Day", data: 'wednesdayWorkingDay', visible: false },
                { title: "Wednesday Lateness Tolerance", data: 'wednesdayLatenessTolerance', visible: false },
                // Thursday
                { title: "Thursday Start Time", data: 'thursdayStartTime', visible: false },
                { title: "Thursday End Time", data: 'thursdayEndTime', visible: false },
                { title: "Thursday Working Day", data: 'thursdayWorkingDay', visible: false },
                { title: "Thursday Lateness Tolerance", data: 'thursdayLatenessTolerance', visible: false },
                // Friday
                { title: "Friday Start Time", data: 'fridayStartTime', visible: false },
                { title: "Friday End Time", data: 'fridayEndTime', visible: false },
                { title: "Friday Working Day", data: 'fridayWorkingDay', visible: false },
                { title: "Friday Lateness Tolerance", data: 'fridayLatenessTolerance', visible: false },
                // Saturday
                { title: "Saturday Start Time", data: 'saturdayStartTime', visible: false },
                { title: "Saturday End Time", data: 'saturdayEndTime', visible: false },
                { title: "Saturday Working Day", data: 'saturdayWorkingDay', visible: false },
                { title: "Saturday Lateness Tolerance", data: 'saturdayLatenessTolerance', visible: false },
            ]
        });
    }
    reloadShiftTable();
        ...
        success: function (successmsg) {
            ...
            $.each(successmsg.d, function (i, item) {
                ...
                if (!aggregatedData[key]) {
                    aggregatedData[key] = {
                        "templateKey": key,
                        "description": item.templateDetails,
                        ...
                        "actionButtons": '<button type="button" class="btn btn-icon btn-primary edit-btn"><i class="bi bi-pencil"></i></button>' +
                            '<button type="button" class="btn btn-icon btn-danger delete-btn"><i class="bi bi-trash"></i></button>',

                        "sundayStartTime": item.workingDay ? formatTimeSpan(item.shiftStart) : '-', 
                        "sundayEndTime": item.workingDay ? formatTimeSpan(item.shiftEnd) : '-',
                        "sundayWorkingDay": item.workingDay,
                        "sundayLatenessTolerance": item.workingDay ? item.latenessToleranceMinutes + ' min' : '-',
...
function createShift() {
    ...
    var formData = {
        Templates: [
            ...
            {
                dayOfTheWeek: 0,
                shiftStart: $('#sundayWorkingDay').is(':checked') ? $('#sundayStartTime').val() : 0,
                shiftEnd: $('#sundayWorkingDay').is(':checked') ? $('#sundayEndTime').val() : 0,
                workingDay: $('#sundayWorkingDay').is(':checked') ? 1 : 0,
                latenessToleranceMinutes: parseInt($('#sundayLatenessTolerance').val(), 10)
            },
            // Monday
            {
                dayOfTheWeek: 1,
                shiftStart: $('#mondayWorkingDay').is(':checked') ? $('#mondayStartTime').val() : 0,
                shiftEnd: $('#mondayWorkingDay').is(':checked') ? $('#mondayEndTime').val() : 0,
                workingDay: $('#mondayWorkingDay').is(':checked') ? 1 : 0,
                latenessToleranceMinutes: parseInt($('#mondayLatenessTolerance').val(), 10)
            },
            // Tuesday
            {
                dayOfTheWeek: 2,
                shiftStart: $('#tuesdayWorkingDay').is(':checked') ? $('#tuesdayStartTime').val() : 0,
                shiftEnd: $('#tuesdayWorkingDay').is(':checked') ? $('#tuesdayEndTime').val() : 0,
                workingDay: $('#tuesdayWorkingDay').is(':checked') ? 1 : 0,
                latenessToleranceMinutes: parseInt($('#tuesdayLatenessTolerance').val(), 10)
            },
            // Wednesday
            {
                dayOfTheWeek: 3,
                shiftStart: $('#wednesdayWorkingDay').is(':checked') ? $('#wednesdayStartTime').val() : 0,
                shiftEnd: $('#wednesdayWorkingDay').is(':checked') ? $('#wednesdayEndTime').val() : 0,
                workingDay: $('#wednesdayWorkingDay').is(':checked') ? 1 : 0,
                latenessToleranceMinutes: parseInt($('#wednesdayLatenessTolerance').val(), 10)
            },
            // Thursday
            {
                dayOfTheWeek: 4,
                shiftStart: $('#thursdayWorkingDay').is(':checked') ? $('#thursdayStartTime').val() : 0,
                shiftEnd: $('#thursdayWorkingDay').is(':checked') ? $('#thursdayEndTime').val() : 0,
                workingDay: $('#thursdayWorkingDay').is(':checked') ? 1 : 0,
                latenessToleranceMinutes: parseInt($('#thursdayLatenessTolerance').val(), 10)
            },
            // Friday
            {
                dayOfTheWeek: 5,
                shiftStart: $('#fridayWorkingDay').is(':checked') ? $('#fridayStartTime').val() : 0,
                shiftEnd: $('#fridayWorkingDay').is(':checked') ? $('#fridayEndTime').val() : 0,
                workingDay: $('#fridayWorkingDay').is(':checked') ? 1 : 0,
                latenessToleranceMinutes: parseInt($('#fridayLatenessTolerance').val(), 10)
            },
            // Saturday
            {
                dayOfTheWeek: 6,
                shiftStart: $('#saturdayWorkingDay').is(':checked') ? $('#saturdayStartTime').val() : 0,
                shiftEnd: $('#saturdayWorkingDay').is(':checked') ? $('#saturdayEndTime').val() : 0,
                workingDay: $('#saturdayWorkingDay').is(':checked') ? 1 : 0,
                latenessToleranceMinutes: parseInt($('#saturdayLatenessTolerance').val(), 10)
            }
        ],
        ShiftDescription: $('#shiftDescription').val(),
        OvertimeRate: parseFloat($('#overtimeRate').val()),
        ExtraOvertimeRate: parseFloat($('#extraOvertimeRate').val())
    };

    if (mode === 'update') {
        formData.templateKey = templateKey;
    }

    var dataToSend = { shiftTemplateWrapper: formData };
    // Send the data using AJAX to your C# backend
    $.ajax({
        url: 'configs.aspx/createShift', // Replace with your endpoint
        type: 'POST',
        contentType: 'application/json',
