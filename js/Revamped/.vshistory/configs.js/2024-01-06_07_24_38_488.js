            ...
            $.each(successmsg.d, function (i, item) {
                ...
                if (!aggregatedData[key]) {
                    aggregatedData[key] = {
                        ...
                        "shiftStart": '<li>' + formatTimeSpan(item.shiftStart) + '</li>',
                        "shiftEnd": '<li>' + formatTimeSpan(item.shiftEnd) + '</li>',
                        "workingDay": item.workingDay ? '<li>Yes</li>' : '<li>No</li>',
                        "latenessTolerance": '<li>' + item.latenessToleranceMinutes + ' min</li>',
