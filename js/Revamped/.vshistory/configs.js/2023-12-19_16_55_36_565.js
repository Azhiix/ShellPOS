        ...
        success: function (response) {
            ...
            parsedRows.forEach(row => {
                table.row.add([
                    ...
                    '<a href="#" class="btn btn-bg-secondary">Download</a> <a href=a href=# onClick=DownloadFile(' + row['uuid'] + ',' + row['file_extension'] +') class="btn btn-bg-primary">View</a>' // Fourth Column HTML
                ]).draw(false);
            }
            );
