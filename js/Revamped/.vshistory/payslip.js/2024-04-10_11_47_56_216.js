...
function printAllPayslips() {
    ...
    loadPayslips(payslipIds).then(data => {
        // 'data' is what was previously 'data.d'
        console.log(data);
        // Here you can use the 'data' to generate HTML or for other purposes
    }).catch(error => {
...
async function loadPayslips(payslipIds) {
    try {
        ...
        const response = await fetch("payslips.aspx/loadPayslip", {
            method: "POST",
            headers: {
                'Authorization': 'Bearer ' + jwtToken,
