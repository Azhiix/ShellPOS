...
function addPayslipsToHTML(payslipHtmlContent) {
    ...
    // Use HTML2Canvas to capture the content of the payslip container
    html2canvas(payslipContainer).then(function (canvas) {
        ...
        // Append the image to the document or perform any further actions
        document.body.appendChild(img);
    $("#payslipContainer").append(payslipHtmlContent);
    // generatePDFA5(payslipHtmlContent);
