...
function printAllPayslips() {
    ...
    // Assuming `getAllPayslipHtml` is a function that returns the combined HTML of all payslips
...
function getAllPayslipHtml() {
    // Example implementation, you need to adapt this based on how your payslips data is structured
    var allPayslipsHtml = "<html><head><title>Payslips</title></head><body>";
    // Loop through your payslips data and generate HTML for each
    // For example, for each payslip data, append its HTML to `allPayslipsHtml`
    allPayslipsHtml += "<div class='payslip'>...</div>"; // This needs to be your actual payslip HTML
