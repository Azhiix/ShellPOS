...
function generatePayslipHTML(payslipData, multires) {
    ...
    initialHtml += `
    <div class ='d-flex
justify-content-center'><div class='row text-center'><div class='col-12'>Absences Taken</div></div>
    <div class='row text-left'><div class='col-12'>Local Leaves: ${absencesTaken.localTaken}</div></div>
<div class='row text-left'><div class='col-6'>Sick Leaves: ${absencesTaken.sickTaken}</div></div>
    ...
    <div class='row text-left'><div class='col-12'>Local Leaves: ${absencesTaken.localTaken}</div></div>`;
    initialHtml += `<div class='row text-left'><div class='col-6'>Sick Leaves: ${absencesTaken.sickTaken}</div></div>`;
