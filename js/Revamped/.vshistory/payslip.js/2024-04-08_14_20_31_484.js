...
function printAllPayslips() {
        ...
        return new Promise((resolve, reject) => {
            jQuery.ajax({
                ...
                success: function (response) {
                    ...
                    // Assuming generatePayslipHTML returns the HTML string for the payslip
                    var res = generatePayslipHTML(payslipData, multiResult);

                    // Append the generated HTML to the payslip container
                    $('#payslipContainer').append(res);
    ...
    // Wait for all payslip requests to complete
    Promise.all(payslipRequests)
        .then(() => {
            // Once all payslip requests are completed, trigger printing
            addPayslipsToHTML($('#payslipContainer').html());
        })
        .catch(error => {
