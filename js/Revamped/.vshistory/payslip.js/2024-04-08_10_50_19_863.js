...
var payslip2js = function () {
    ...
    return {
        ...
        updatePayslipData: function (newData) {
            payslipData = newData;
        },
getPayslipData: function () {
            return payslipData;
        }
        ...
        jQuery.ajax({
            ...
            success: function (msg) {
                if (msg.d == null) {
                    ...
                    console.log(msg.d);
                    payslip2js.updatePayslipData(msg.d) 
...
function printAllPayslips() {
    var payslipData = payslip2js.getPayslipData(); // Retrieve stored payslip data
    if (!payslipData || payslipData.length === 0) {
        alert("No payslip data to print. Please perform a search first.");
        return;
    }
    ...
    // Generate the HTML for all payslips
    ...
    payslipData.forEach(function (payslip) {
       console.log(payslip)
        allPayslipsHtml += `<div>
            ...
            <p>Company Name Salary: ${payslip.company_name}</p>
