...
function addPayslipsToHTML(payslipHtmlContent) {
    ...
    if (!iframe) {
        ...
        iframe.style.display = 'none'; // Consider making visible for debugging
    ...
    div.innerHTML = payslipHtmlContent; // This now contains the <img> tag
    doc.body.appendChild(div);

    // Optionally, print after adding content
