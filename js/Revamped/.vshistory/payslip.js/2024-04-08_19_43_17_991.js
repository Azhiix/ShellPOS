...
function generatePDFA5(htmlString) {
    // First, create a 'div' to temporarily hold your HTML content for measurement
    const tempDiv = document.createElement('div');
    tempDiv.innerHTML = htmlString;
    tempDiv.style.visibility = 'hidden'; // Make the div invisible to avoid flickering
    document.body.appendChild(tempDiv);

    // Use html2canvas to take a snapshot of your tempDiv
    html2canvas(tempDiv, { scale: 2 }).then(canvas => {
        ...
        // This loop will add new pages as needed based on the content height
        do {
        ...
        // Finally, open the PDF in a new window
...
function addPayslipsToHTML(payslipHtmlContent) {
    ...
    //    //iframe.style.display = 'none'; // Consider changing this if you want to visually debug the iframe content
    ...
    //div.innerHTML = payslipHtmlContent;
    //doc.body.appendChild(div);a

    var payslipContainer = $("#payslipContainer")
    payslipContainer.empty()
    payslipContainer.append(payslipHtmlContent);

    generatePDFA5(payslipContainer.html())
   
    
    //var restorepage = $('body').html();
    //var printcontent = $('#payslipContainer').clone();
    //$('body').empty().html(printcontent);
    //window.print();
    //$('body').html(restorepage);

    // Directly print after adding content
