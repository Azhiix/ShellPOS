...
function initEvents() {
    ...
    const emPins = []
    console.log("The empPins are", emPins)
    ...
    $('#idPs2Table').on('click', '.viewPayslip', function () {
        ...
        jQuery.ajax({
            ...
            success: function (response) {
                ...
                //iterate over each empPin and push it to the array
                for (var i = 0; i < response.d.length; i++) {
                    emPins.push(response.d[i].payroll.emp_pin)
                }
                // console.log("The empPins are", emPins)
                // console.log("The last empPin is", emPins[emPins.length - 1])
                var empPin = emPins[emPins.length - 1]
                //
                console.log("last console log is", empPin)
...
function getAllPayslipHtml(empPin) {
