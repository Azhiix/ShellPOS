...
function printAllPayslips() {
    ...
    Promise.all(payslipPromises).then(allPayslipHtmlContents => {
        ...
        html2canvas(tempDiv).then(canvas => {
            ...
            // Append the canvas to the body or directly print it
            // For demonstration, appending to body. You might want to directly print it or handle differently.
            document.body.appendChild(canvas);

            // Optionally, to print the canvas, convert it to an image and print
