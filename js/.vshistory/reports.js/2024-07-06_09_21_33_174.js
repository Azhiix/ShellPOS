document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('generatePDF').addEventListener('click', function () {
        ...
        doc.text('Shell Ebene Serviice Station', 10, 30);


        doc.setFontSize(11)
        doc.setFont('Calibri', 'normal');
        doc.text('Barin Co Ltd', 10, 30);
        ...
        doc.setFontSize(10);
        doc.setFont('helvetica', 'normal');
        doc.text('Ebene, Mauritius', 10, 35);

        doc.setFontSize(10);
        doc.setFont('helvetica', 'normal');
        doc.text('Telephone and Fax' + '+2304646765', 10, 40);


        doc.setFontSize(10);
        doc.setFont('helvetica', 'normal');
        doc.text('Email: ' + ' +barin.ebene@gmail.com', 10, 45);
