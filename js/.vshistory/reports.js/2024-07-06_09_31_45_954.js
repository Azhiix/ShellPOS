document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('generatePDF').addEventListener('click', function () {
        ...
        const clientId = document.getElementById('clientSelect').value;
        const vehicleRegNo = document.getElementById('vehicleRegNo').value;
        const saleDate = salesGridOptions.rowData[0].SaleDate;

        // Company Details
        doc.setFontSize(10);
        doc.setFont('helvetica', 'normal');
        doc.text('Shell Ebene Service Station', 10, 30);
        doc.text('Barin Co Ltd', 10, 35);
        doc.text('Ebene, Mauritius', 10, 40);
        doc.text('Telephone and Fax: +2304646765', 10, 45);
        doc.text('Email: barin.ebene@gmail.com', 10, 50);
        doc.text("BRN: 012882822828", 10, 70);
        ...
        doc.text("Date From: " + formattedDateFrom, 150, 60);
        doc.text("Date To: " + formattedDateTo, 150, 65);

        // Table Header
        doc.setFontSize(10);
        doc.setFont('helvetica', 'bold');
        doc.text("Item Code", 10, 80);
        doc.text("Item Description", 40, 80);
        doc.text("Quantity", 100, 80);
        doc.text("Price (Ex)", 120, 80);
