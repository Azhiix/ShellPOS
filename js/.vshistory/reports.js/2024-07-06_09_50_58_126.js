document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('generatePDF').addEventListener('click', function () {
        ...
        // Title
        doc.text("BARIN CO LTD", 105, 20, { align: 'center' });

        // Sub-Title
        doc.setFontSize(10);
        doc.text("NAWSHAD HAULKORY", 105, 30, { align: 'center' });
        doc.text("JUNE 2024", 105, 40, { align: 'center' });
        ...
        doc.setFont('helvetica', 'bold');
        doc.text("Date", 10, 60);
        doc.text("Invoice Num", 50, 60);
        doc.text("Details", 100, 60);
        doc.text("AMT (RS)", 150, 60);
