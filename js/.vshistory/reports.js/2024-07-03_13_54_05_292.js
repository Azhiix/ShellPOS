document.addEventListener('DOMContentLoaded', function () {
    ...
    const salesGridOptions = {
        ...
        columnDefs: [
            { field: "SaleId", headerName: "SaleId", width: '50px', resizable: true },
    ...
    document.getElementById('getSales').addEventListener('click', function (e) {
        ...
        const agentName = document.getElementById('agentSelect').value; // Corrected line
        ...
        const payload = {
            ...
            agentName: agentName // Added to payload
        };
