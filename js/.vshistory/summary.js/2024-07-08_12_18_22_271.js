...
function printElement(element) {
    ...
    document.querySelectorAll('.print-button').forEach(btn => btn.classList.add('d-none'));
    ...
    printWindow.onload = function () {
        ...
        document.querySelectorAll('.print-button').forEach(btn => btn.classList.remove('d-none'));
    };
}
