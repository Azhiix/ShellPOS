$(document).ready(function () {
    ...
    function updateTotals() {
        ...
        var quantity = parseFloat($('#fuelQuantity').val() || $('#waterQuantity').val() || $('#couponQuantity').val()) || parseFloat($('#regulatorQuantity').val());
        ...
        if (selectedType.startsWith('coupon')) {
            ...
            $('#totalRegulatorCost').show();
            console.log(totalRegulatorCost); 
        } else {
...
elseif(selectedType.includes('gasRefill')) {

    var gasRefillPrice = parseFloat($('#subCategory option:selected').text().split(" - Rs ")[1]);
    var gasRefillTotalCost = gasRefillPrice * quantity;
    $('#totalGasRefill').val(gasRefillTotalCost.toFixed(2));
    $('#totalGasRefill').show();
    console.log(gasRefillTotalCost);
    console.log(gasRefillPrice);
    console.log(quantity);
    console.log(selectedType);
    console.log(gasRefillTotalCost.toFixed(2));
    console.log(gasRefillPrice.toFixed(2));
    console.log(quantity.toFixed(2));
    console.log(selectedType.toFixed(2));
