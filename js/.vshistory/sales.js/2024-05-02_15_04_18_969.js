$(document).ready(function () {
    ...
    $('#mainDropdown .js-example-basic-single').on('change', function () {
        ...
        var $gasQuantityInput = $('#gasQuantityInput');
    ...
    // Function to update totals based on selected options and quantities
    function updateTotals() {
        var selectedType = $('#subCategory').val();
        var quantity = parseFloat($('#fuelQuantity').val() || $('#waterQuantity').val() || $('#couponQuantity').val());
