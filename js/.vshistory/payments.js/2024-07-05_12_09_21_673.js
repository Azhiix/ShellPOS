...
function submitPayment(event) {
    ...
    //dateFrom, string dateTo, string specificDate, decimal Amount, string Reference, string Comments, int clientId, int paymentTypeId
    ...
    const paymentTypeId = document.getElementById('paymentType').value; // Assuming there's a select element with id 'paymentType'
