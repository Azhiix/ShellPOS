...
function submitPayment(event) {
    ...
    //(string dateFrom, string dateTo, string specificDate, decimal amount, string reference, string comments, int clientId, int paymentTypeId)
    ...
    const specificDate = null // Assuming there's an input for specific date
