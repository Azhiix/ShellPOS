    ...
    fetch('payments.aspx/displayClientSales', {
        ...
        .then(data => {
            ...
            if (data && data.d) {
                ...
                fetchPayments(payload.clientID); // Fetch payments for the selected client
            } else {
...
function determineWhetherSaleDateIsWithinSearchPeriod(saleDate, searchPeriod) {
    const [searchPeriodFrom, searchPeriodTo] = searchPeriod;
    return saleDate >= searchPeriodFrom && saleDate <= searchPeriodTo;
}
