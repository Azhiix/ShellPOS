...
$(document).ready(function () {
    ...
    $('#clientSubmit').click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "admin.aspx/CreateClient", // Assuming the WebMethod is named CreateClient
            contentType: 'application/json; charset=utf-8',
            dataType: 'json',
            data: JSON.stringify({
                name: clientName, // Match these names to your WebMethod parameters
                address: clientAddress,
                contactInfo: contactInfo,
                brn: brnNo
            }),
            success: function (response) {
                // Handle success here, like updating the UI or showing a success message
